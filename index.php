...
<body>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="d-flex  flex-column flex-lg-row align-items-center w-100 justify-content-between">
              <ul class="navbar-nav  ">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="buy.php">ঔষধ</a>
                </li>
                <li class="nav-item">
              ...
              <div class="row">
                ...
                <div class="col-md-8">
                  <div class="detail-box">
                    <h1>
                      <span>
                        <P> অনলাইন ঔষধ</P>কেন্দ্র
                      </span>

                    </h1>
                    <p>
                      স্বাচ্ছন্দে কেনা কাটা করুন আমাদের সাথে।
                    </p>
                    <div>
                      <a class="nav-link" href="buy.php">এখনই অর্ডার দিন
                      </a>
                    </div>
                  </div>
                </div>
              ...
              <div class="row">
                ...
                <div class="col-md-8">
                  <div class="detail-box">
                    <h1>
                      <span>
                        এখনই অর্ডারে আপনি ৫% ছাড়ে যেকোনো ওষুধ পাবেন।
                      </span>
                    </h1>
                    <div>
                      <a class="nav-link" href="buy.php">এখনই অর্ডার দিন
              ...
              <div class="row">
                ...
                <div class="col-md-8">
                  <div class="detail-box">
                    <h1>
                      <span>
                        আমরা দিচ্ছি হোম ডেলেভারি সম্পূর্ণ ফ্রি।
                      </span>
        ...
        ?>
          <div class="item">
            <div class="box">
              ...
              <div class="img-box">
                <img src="<?php echo $row['image']?>" height="240" alt="">
              </div>
      ...
      <div class="feature_container">
        <div class="box">
          ...
          <div class="detail-box">
            ...
            <p>
              ৩০ মিনিটের মধ্যে পন্য পৌঁছে দেওয়া হয়।
            </p>
          </div>
        </div>
        <div class="box">
          ...
          <div class="detail-box">
            ...
            <p>
              Trade License: TRAD/DNCB/047302/2022
            </p>
          </div>
        </div>
        <div class="box">
          ...
          <div class="detail-box">
            ...
            <p>
              প্রতিদিন সকাল ৯টা থেকে রাত ৯টা পর্যন্ত সেবা দেওয়া হয়।
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="info_contact">
            ...
            <div class="box">
              ...
              <div class="detail-box">
                <h6>
                  <a href="https://www.gmail.com" target="blank">amithasanjoy655@gmail.com</a>
                </h6>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-3">
          <div class="info_menu">
            ...
            <ul class="navbar-nav  ">
              <li class="nav-item active">
                <a href="https://www.facebook.com/profile.php?id=100009098296813" target="blank">
  ...
  <section class="container-fluid footer_section">
    <p>
      &copy; 2022 Sustho Thakun Limited. All rights reserved.(Made By Amit Hasan)
    </p>
  </section>
  <!-- footer section -->
